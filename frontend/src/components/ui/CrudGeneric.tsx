                ...
                <tr key={item.id} className="hover:bg-gray-50 transition-colors duration-150">
                  {columns.map((col) => (
                    <td 
                      ...
                      className="px-6 py-4 whitespace-nowrap text-base text-gray-800 
                                 max-w-xs overflow-hidden text-ellipsis" // Added max-w-xs, overflow-hidden, text-ellipsis for potential long text
                    >
                      {renderRow ? (
                        renderRow(item, col)
                      ) : col === "status" ? (
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-base font-medium w-28 min-w-[112px]">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-48 bg-white shadow-lg rounded-md py-1">
                        <DropdownMenuItem
